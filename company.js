...
const COMPANY_BRAND = "ASCOM MOBILE SOLUTIONS";
...
export async function addCompanyToCompanyCore(company, cif, anafData, careersPage) {
  ...
  const companyCoreData = {
    ...
    website: ["https://www.ascom.com/ro"],
    career: [careersPage || "https://career.ascom.com/jobs"],
    lastScraped: now,
    scraperFile: "https://raw.githubusercontent.com/sebiboga/ascom-mobile-solutions-romania-srl-nodejs-scraper/main/.github/workflows/scrape.yml"
  };
